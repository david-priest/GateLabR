...
GateLabR and [GateLab](https://github.com/david-priest/GateLab) share the same gating
...
Use **GateLab** for a browser-based workflow with no R installation. Use **GateLabR**
when you want populations written directly back to a `SingleCellExperiment` for a
Bioconductor analysis pipeline.

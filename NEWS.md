...
- The embedded GateLab core is 0.7.6 (GateLab-dev master), which sends the memberships with an explicit save and, when the plot pools several checked files, labels gate counts pooled over the same files.

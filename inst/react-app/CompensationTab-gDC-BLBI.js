...
import { D as Wt, r as Xi, l as Ji, s as Qi, z as er, u as Re, a as M, j as e, b as me, v as As, c as nr, d as tr, e as Ts, f as sr, F as ir, g as rr, h as ar, C as or, i as lr } from "./embed-BbLvKWsr.js";
...
async function Fr(n, i, r, a) {
  ...
  if (r === "pdf") {
    const { jsPDF: f } = await import("./jspdf.es.min-D6upbH1z.js").then((C) => C.j), N = new f({ orientation: "landscape", unit: "pt", format: "a4", compress: !0 }), E = N.internal.pageSize.getWidth(), v = N.internal.pageSize.getHeight();
    for (let C = 0; C < o; C++) {

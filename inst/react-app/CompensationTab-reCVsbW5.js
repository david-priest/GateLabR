...
import { D as Yt, r as tr, l as ir, s as sr, z as rr, u as Le, a as M, j as e, b as me, c as ne, p as en, v as Ut, d as ar, e as or, f as lr, g as cr, h as Ki, i as dr, F as ur, k as hr, m as pr, C as mr, n as fr } from "./embed-D4X-AL0o.js";
...
async function Lr(n, s, r, a) {
  ...
  if (r === "pdf") {
    const { jsPDF: f } = await import("./jspdf.es.min-zePAD3OY.js").then((S) => S.j), w = new f({ orientation: "landscape", unit: "pt", format: "a4", compress: !0 }), k = w.internal.pageSize.getWidth(), v = w.internal.pageSize.getHeight();
    for (let S = 0; S < o; S++) {
